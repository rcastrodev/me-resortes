...
class MailController extends Controller
{
    ...
    public function quote(Request $request)
    {
        $request->validate([
            ...
            'telefono'              => 'required',
            'tipo_de_alambre'       => 'required',
            'diametro_de_alambre'   => 'required',
            'diametro_exterior'     => 'required',
            'diametro_interior'     => 'required',
            'largo'                 => 'required',
        ], [
            ...
            'tipo_de_alambre.required'  => 'Tipo de alambre es requerido',
            'diametro_de_alambre.required' => 'Diámetro de alambre es requerido',
            'diametro_exterior.required'   => 'Diámetro exterior es requerido',
            'diametro_interior.required'   => 'Diámetro interior es requerido',
            'largo.required'            => 'Largo requerido',
        ]);
