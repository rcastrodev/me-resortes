<div class="modal fade" id="modal-update-element">
    <form action="{{ route('application.content.generic-section.update') }}" method="post" id="form-update-slider" class="modal-dialog">
        @csrf
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <small>la imagen debe ser al menos 366x285</small>
            </div>    
        </div>
