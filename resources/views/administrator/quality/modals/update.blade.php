<div class="modal fade" id="modal-update-element">
    <form action="{{ route('quality.content.generic-section.update') }}" method="post" id="form-update-slider" class="modal-dialog">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <small>la imagen debe ser al menos 32x32</small>
            </div>    
        </div>
