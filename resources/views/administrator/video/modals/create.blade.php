<div class="modal fade" id="modal-create-element">
    <form action="{{ route('video.content.generic-section.store') }}" method="post" class="modal-dialog" data-info="reset">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="text" name="image" class="form-control" placeholder="código del video">
            </div> 
            <div class="form-group">
